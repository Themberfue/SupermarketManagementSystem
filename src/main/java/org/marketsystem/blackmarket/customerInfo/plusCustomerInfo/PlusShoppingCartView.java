...
import org.marketsystem.blackmarket.customerInfo.commonCustomerInfo.CommonProductSelectionView;

public class PlusShoppingCartView extends Pane {

    public PlusShoppingCartView() {
        // 图像
        ...
        buyButton.setOnAction(e -> {
            ...
            parent.getChildren().add(new PlusProductSelectionView());

            // 更新按钮样式
            PlusCustomerInfo plusCustomerInfo = (PlusCustomerInfo) parent.getScene().getWindow().getUserData();
            plusCustomerInfo.updateButtonStyles(1);
        });
    }
}