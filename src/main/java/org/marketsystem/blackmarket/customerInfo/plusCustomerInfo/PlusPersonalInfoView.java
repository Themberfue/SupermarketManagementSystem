...
public class PlusPersonalInfoView extends Pane {
        public PlusPersonalInfoView() throws SQLException, ClassNotFoundException {
            ...
            // 保存按钮
            String defaultStyle = "-fx-background-color: #FFD700; -fx-text-fill: black; -fx-padding: 10 20; -fx-cursor: hand; -fx-font-size: 20px;";
            Button saveButton = new Button("保存");
            saveButton.setStyle(defaultStyle);
            saveButton.setOnMouseEntered(e -> {
                saveButton.setStyle("-fx-background-color: #FFA500; -fx-text-fill: black; -fx-padding: 10 20; -fx-cursor: hand; -fx-font-size: 20px;");
            });
